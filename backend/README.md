...
## Project Structure
    ...
    ├── shzb_screens_batch__31416  # Django project configurations
...
1. Clone this repo and `cd shzb_screens_batch__31416`
...
2. Clone this repo and `cd shzb_screens_batch__31416`
